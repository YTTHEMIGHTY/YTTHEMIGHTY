...
```json
{
  ...
  "version": "5.0.0",
  "description": "Senior Full Stack Engineer specializing in the JavaScript ecosystem",
  "main": "react + next.js + node.js",
  "scripts": {
    "build": "scalable enterprise apps",
    "dev": "server-driven UIs with blazing-fast performance",
  ...
  <tr>
    ...
    <td>
      <a href="https://skillicons.dev">
        <img src="https://skillicons.dev/icons?i=js,ts,react,nextjs,redux,tailwind,materialui&perline=7" />
      </a>
    </td>
  </tr>
  <tr>
    ...
    <td>
      <a href="https://skillicons.dev">
        <img src="https://skillicons.dev/icons?i=nodejs,express,graphql,mongodb,postgres,aws,docker&perline=7" />
      </a>
    </td>
  </tr>
  <tr>
    ...
    <td>
      <a href="https://skillicons.dev">
        <img src="https://skillicons.dev/icons?i=vite,webpack,jest,vitest,figma,git,github&perline=7" />
      </a>
    </td>
  </tr>
</table>
...
<div align="center">
  <img src="https://streak-stats.demolab.com/?user=YTTHEMIGHTY&theme=transparent&hide_border=true" alt="streak stats" />
</div>
